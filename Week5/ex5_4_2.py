...
# Load audio files
x, Fs = librosa.load(os.path.join(DATA_DIR, 'ambulance.wav'), sr=16000)
y, Fs = librosa.load(os.path.join(DATA_DIR, 'ambulance_speech.wav'), sr=16000)
...
sf.write(os.path.join(os.path.dirname(__file__), '5_4_2_filter_output.wav'), y-yhat, Fs, subtype='PCM_24')

# read original speech without noise
o, Fs = librosa.load(os.path.join(DATA_DIR, 'kennedy.wav'), sr=16000)
